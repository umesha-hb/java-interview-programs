...
public class HashMapDs {
	...
	public void put(Employee key, String value) {
		...
		Node existingElement = table[bucket];
		...
		NodeInOldBucket.next = table[bucket];
		table[bucket] = NodeInOldBucket;
	}
